...
## 支持直接从mapper. 调用的时候就做代码提示和生成 (3.4.0)
![fromMethodCall](https://images.brucege.com/mapperCallCompletion.gif)
...
- 方法名生成sql需要一个BaseResultMap里面包含@Table注释，可以在表上右键使用mybatis generator左下角有个预览xml来生成好
