...
### 插件可能会和其他的mybatis插件冲突，如 mybatisX,freeMybatisPlugin,mybatisPlugin,ToolKit.(mybatisLogPlugin没有冲突),如果发现比如方法名生成sql找不到对应的xml文件等，请先卸载掉其他的mybatis插件 然后使用 invalidate Cache and restart. http://myimages.brucege.com/invalidateCacheAndRestart.png
...
![register](http://myimages.brucege.com/register_new.gif)

- 或者可以在设置界面激活
![registerInSetting](http://myimages.brucege.com/registerInSettings.png)
...
![offline](http://myimages.brucege.com/offlineActivation.png)
...
![unBind](http://myimages.brucege.com/unBind.png)
