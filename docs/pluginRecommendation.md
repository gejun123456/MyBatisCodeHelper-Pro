...
截图:
![ignoreFileGenerator](http://myimages.brucege.com/ignoreFileGenerator.png)
...
截图：
![lombokPlugin](http://myimages.brucege.com/lombokPlugin.gif)
...
截图:
![findBugs](http://myimages.brucege.com/findBugs.gif)

5. [GsonFormat](https://plugins.jetbrains.com/plugin/7654-gsonformat)
一键根据json文本生成java类  非常方便

截图:
![gsonformat](http://myimages.brucege.com/gsonformat.gif)
...
截图:
![mavenhelper](http://myimages.brucege.com/mavenhelper.png)
...
截图:
![generaetAllSetter](http://myimages.brucege.com/generaetAllSetter.gif)
...
截图:
![mybatisCodeHelperPro](http://myimages.brucege.com/mybatisCodeHelperPro.gif)

9. [singleton](https://plugins.jetbrains.com/plugin/9415-singleton)

一键生成单例
![generaetSingletion](http://myimages.brucege.com/generaetSingletion.gif)
...
截图：
![customPosix](http://myimages.brucege.com/customPosix.gif)
...
![intellijPacakgeSearch](http://myimages.brucege.com/intellijPacakgeSearch.gif)

12. [LivePlugin](https://plugins.jetbrains.com/plugin/7282-liveplugin/versions)

快速写idea的插件，配置一个kotlin的类就可以跑了，可以用来快速增加字段注解啥的。
![liveplugindemo](http://myimages.brucege.com/liveplugindemo.gif)
...
截图:
![rainbowbrackets](http://myimages.brucege.com/rainbowbrackets.png)

2. [Translation](https://plugins.jetbrains.com/plugin/8579-translation)

最好用的翻译插件，功能很强大，界面很漂亮
![translations](http://myimages.brucege.com/translations.gif)
