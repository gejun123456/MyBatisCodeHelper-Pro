...
![springTestCase](http://youpaiyuntupian.test.upcdn.net/springtestCase.gif)
...
![quickTestJavaMapper](http://youpaiyuntupian.test.upcdn.net/quickTestJavaMapper.png)

配置文件
![quickTestConfiguration](http://youpaiyuntupian.test.upcdn.net/quickTestConfiguration.png)

这样我们可以直接测试mybatis的sql而不需要启动spring

速度非常快 如下：

![testSpeed](http://youpaiyuntupian.test.upcdn.net/quickTestNoSpring.gif)
...
![testCaseAdditionalConfig](http://youpaiyuntupian.test.upcdn.net/testCaseAdditionalConfig.png)
