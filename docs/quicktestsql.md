...
![springTestCase](https://myimages.brucege.com/springtestCase.gif)
...
![quickTestJavaMapper](https://myimages.brucege.com/quickTestJavaMapper.png)

配置文件
![quickTestConfiguration](https://myimages.brucege.com/quickTestConfiguration.png)

这样我们可以直接测试mybatis的sql而不需要启动spring

速度非常快 如下：

![testSpeed](https://myimages.brucege.com/quickTestNoSpring.gif)
...
![testCaseAdditionalConfig](https://myimages.brucege.com/testCaseAdditionalConfig.png)
